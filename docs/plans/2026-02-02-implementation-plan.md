...
| 文件 | 内容 | 任务数 | 预估时间 |
|------|------|--------|----------|
| `00-project-setup.md` | 项目初始化 | 6 | ~2h |
| `01-material-library.md` | 物料库管理 | 6 | ~3h |
| `02-process-rates.md` | 工艺费率配置 | 4 | ~1.5h |
| `03-bom-parser.md` | BOM 解析引擎 | 5 | ~3h |
| `04-dual-calculator.md` | 双轨计算器 | 4 | ~2.5h |
| **总计** | **5 个切片** | **25** | **~12h** |
