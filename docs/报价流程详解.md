...
|--------|----------|----------|----------|--------|
| v1.1   | 2026-02-13 | 2026-02-15 | Dr.aiVOSS 完整报价流程 | Randy Luo |
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v1.1 | 2026-02-15 | 🔴 **明确 HK III 交付流程**：新增 §3.6.3 VM → Sales 交付流程图；明确 VM 交付成果物为 HK III（制造成本）；新增 HK III 校验规则和 Sales 接收数据结构 |
...
> **详细定义：** [NRE投资成本计算逻辑.md](NRE投资成本计算逻辑.md#投资类型) - 唯一来源
...
| 夹具 | JIG | 定位与固定 |
| 工装 | FIXTURE | 辅助加工 |
| 成型工装 | FORMING_TOOL | 管件成型（弯管、端部成型）|
...
> **详细公式：** [NRE投资成本计算逻辑.md](NRE投资成本计算逻辑.md#分摊计算) - 唯一来源
