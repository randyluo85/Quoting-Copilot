...
|--------|----------|----------|----------|--------|
| v1.8   | 2026-02-03 | 2026-02-05 | Dr.aiVOSS 智能快速报价助手 PRD | Randy Luo |
...
| **v1.8** | **2026-02-05** | **Randy Luo** | **架构调整：移除双轨计价功能，简化为单一标准成本计算；Payback 功能暂时下架** |
...
**注意：** 此功能在 v1.8 版本中暂时下架，后续版本会重新启用。
