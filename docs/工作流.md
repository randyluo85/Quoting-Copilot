...
|---------|---------|
| 新增功能 | docs/变更记录.md |
| 修改 API | AGENTS.md, docs/产品需求文档.md |
| 修改数据表 | docs/数据库设计.md |
| 修改业务逻辑 | PROJECT_CONTEXT.md |
| 修改公式口径/状态机/术语 | docs/文档基线清单.md + 对应唯一来源文档 |

### 5.2 文档基线

- 唯一来源矩阵请参考：`docs/文档基线清单.md`
- 非唯一来源文档只能做摘要，不可定义新口径
- 改唯一来源时，必须同提交同步所有引用文档
### 5.3 文档版本管理
