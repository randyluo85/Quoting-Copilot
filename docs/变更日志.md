...
| 触发条件 | 更新文档 | 责任人 |
|----------|----------|--------|
| PRD 需求变更 | [产品需求文档.md](产品需求文档.md), [../PROJECT_CONTEXT.md](../PROJECT_CONTEXT.md) | 产品经理 |
| 数据库结构变更 | [数据库设计.md](数据库设计.md) | 后端负责人 |
| API 接口变更 | [API参考文档.md](API参考文档.md), [../CLAUDE.md](../CLAUDE.md) | 后端负责人 |
| 新增计算逻辑 | 对应逻辑文档 | 业务分析师 |
| 部署方式变更 | [部署指南.md](部署指南.md) | DevOps |
