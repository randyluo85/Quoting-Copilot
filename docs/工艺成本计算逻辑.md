...
| 表名 | 用途 | 详细定义位置 |
|------|------|-------------|
| `cost_centers` | 产线主数据（含租金单价、能源单价、利率等固定参数） | [数据库设计.md §3.3](数据库设计.md#master-data-extension) |
...
| 文档 | 关联点 |
|------|--------|
| [数据库设计.md](数据库设计.md) | 依赖 `cost_centers`, `process_rates`, `product_processes`, `work_center_time_rules` 表 |
