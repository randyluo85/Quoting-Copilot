...
| 分类 | 工序编号 | 工序名称 | 典型工作中心 |
|------|---------|---------|-------------|
| **切管类** | 01 | 切PA管 | 40042, 80012 |
| | 02 | 切波纹管 | 40018, 80021 |
| | - | 切管-光管 | 40001 |
| **成型类** | 04-1 | 成型组装（安装拆卸） | 40021, 80021 |
| | 04-2 | 管路成型（回转炉） | 40027, 80024 |
| | - | 管路成型（蒸汽） | 40012, 80012 |
| | - | 回转炉成型 | 40027, 80024 |
| **组装类** | 03 | 组装护套4种 | 40021, 80021 |
| | 03-1 | 组装接头 | 40028 |
| | 03-2 | BESS-储能组装 | 40032, 40031 |
| | 06 | 组装零部件 | 40021, 80021 |
| | 06 | 组装保温棉+胶带 🆕 | 40021, 80021 |
| | 03-1 | 组装接头（Manual assembly QC） | 40028 |
| **标识类** | 08 | 激光打码 | 40023 |
| | - | 组装标签&激光打码 🆕 | 40023 |
| **检测类** | 07 | 检具检查 | 40021, 80021 |
| | 09 | 气密检测 | 40036, 80036 |
| | - | 气密性检测（100% Leakage test） | 40036, 80036 |
| **其他** | 05 | 三合一（回切倒角吹气端部检） | 40050, 80035 |
| | 10 | 打包 | 40021, 80021 |
| | - | 包装（Packing） | 40021, 80021 |
...
- **格式**：`工序1编号 + 工序2编号 + ...`
- **示例**：`01-03-06-10` = 切PA管 → 组装护套 → 组装零部件 → 打包
