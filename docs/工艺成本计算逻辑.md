...
|--------|----------|----------|----------|--------|
| v2.9   | 2026-02-03 | 2026-03-11 | 工艺成本计算逻辑 | Randy Luo |
...
| v2.9 | 2026-03-11 | 🔴 **工序编码规则重构**：基于ASUS标准工时表更新工序编码规则；工序编号改为纯数字（01-10），支持子编号（04-1, 04-2）；工作中心编号改为5位数字（前2位为工厂代码：40=济南，80=常州）；补充新增工序（组装保温棉+胶带、组装标签&激光打码、BESS储能组装等） |
