...
|------|------|------|----------|----------|------|
| 2026-03-07 | docs/工艺成本计算逻辑.md | v2.6 → **v2.7** | 🔴 **工时规则细化**：补充 S/PC 标准、Cycle time 转换公式、实际工时计算公式、系数机制、长度分段规则（基于 ASUS 标准工时表）；统一工序编码体系（M01/A01/T01）；移除"管子根数"引用 | 工艺成本计算 | Randy Luo |
