...
|--------|----------|----------|----------|--------|
| v1.4   | 2026-02-03 | 2026-02-05 | Payback 计算逻辑与 BOM 映射 | Randy Luo |

---

**⚠️ 功能状态说明：Payback 功能暂时下架**

原 Payback 计算逻辑基于 VAVE 价格节省额，由于系统已移除 VAVE 价格功能，本模块暂时下架。
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v1.4 | 2026-02-05 | 🔴 功能暂时下架：原逻辑基于 VAVE 价格节省额，现已移除 VAVE 功能 |
