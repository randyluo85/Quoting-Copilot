...
| **vehicle_vol** | **INT** | | **🆕 整车产量** |
| **factor_per_vehicle** | **DECIMAL(10,4)** | | **🆕 单车用量** |
| volume | INT | NOT NULL | 销量（= vehicle_vol × factor_per_vehicle） |
...
**🆕 销量计算逻辑：**
$$Volume_n = Vehicle\_Vol_n \times Factor\_per\_vehicle$$
