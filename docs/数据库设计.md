...
| 2026-03-02 | v1.15 | 🔴 **术语统一**：`production_lines` 表重命名为 `production_lines`（成本中心 → 产线）；相关字段和外键同步更新 | 全局术语 |
...
| **production_line_id** | **VARCHAR(20)** | **FK** | **🔴 v1.3 新增：关联成本中心** |
...
|------|------|------|------|
| id | INT | PK, AUTO_INCREMENT | |
| production_line_id | VARCHAR(20) | FK, NOT NULL | 关联成本中心 |
